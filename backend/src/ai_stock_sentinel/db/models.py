...
class UserWatchlist(Base):
    ...
    __table_args__ = (
        ...
        Index("idx_user_watchlist_user_sort_order", "user_id", "sort_order"),
...
class Phase1AvwapSnapshot(Base):
    ...
    dataset: Mapped[str] = mapped_column(String(50), nullable=False, default="phase1_daily_ohlcv_amount", server_default="phase1_daily_ohlcv_amount")
    adjustment_mode: Mapped[str] = mapped_column(String(20), nullable=False, default="unadjusted", server_default="unadjusted")
    source_provider: Mapped[str] = mapped_column(String(30), nullable=False, default="twse", server_default="twse")
