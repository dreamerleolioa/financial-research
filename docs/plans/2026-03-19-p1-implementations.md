...
對應 spec：`docs/specs/ai-stock-sentinel-execution-roadmap-spec.md` §4.2
...
對應 spec：`docs/specs/ai-stock-sentinel-execution-roadmap-spec.md` §4.3
...
對應 spec：`docs/specs/ai-stock-sentinel-execution-roadmap-spec.md` §4.1
  ...
  result?.action_plan && (
    <div className="rounded-xl border border-card-border bg-card-bg p-4 space-y-4">
      ...
      <div className="flex items-start justify-between gap-2">
        <p className="text-sm font-medium text-card-text flex-1">{result.action_plan.action}</p>
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {result.action_plan.conviction_level && (
            <span
              className={`rounded-full px-2 py-0.5 text-xs font-medium ${CONVICTION_BADGE[result.action_plan.conviction_level].cls}`}
            >
      ...
      {/* 段落四：失效條件 */}
      {result.action_plan.invalidation_conditions &&
        result.action_plan.invalidation_conditions.length > 0 && (
          <div>
...
### 對照 `docs/specs/ai-stock-sentinel-execution-roadmap-spec.md` §4.1
...
### 對照 `docs/specs/ai-stock-sentinel-execution-roadmap-spec.md` §4.2
...
### 對照 `docs/specs/ai-stock-sentinel-execution-roadmap-spec.md` §4.3
