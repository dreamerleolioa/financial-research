...
這代表 live run 的 universe 上限大約是 100 檔，來自 same-day combined top 50 加上 recent top 50，實際數量會因兩條軌道重疊去重而更低。MVP 原始設計仍排除 ETF、權證、特別股與資料欄位明顯不完整標的，但目前 live default 是雙軌選出的候選 universe，不是完整上市櫃全市場逐檔掃描。
