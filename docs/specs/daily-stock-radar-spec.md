...
2. Action 以分段 schedule 呼叫 Zeabur 後端 internal endpoints：18:00 `prepare-universe`、19:00 `refresh-avwap`、20:00 `refresh-lending`、21:30 `refresh-full-margin`、22:30 `refresh-ohlcv`、23:30 `refresh-market-context`、隔日 00:30 `run-scoring`。
